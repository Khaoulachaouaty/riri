...
import { Business, DashboardOutlined, GroupsOutlined } from "@mui/icons-material";
...
const Array1 = [
  ...
  { text: "Employées", icon: <GroupsOutlined />, path: "employees" },
  { text: "Client", icon: <Business />, path: "client" },
...
const SideBar = ({ open, handleDrawerClose }) => {
  ...
  return (
    <CustomDrawer variant="permanent" open={open}>
      <DrawerHeader>
      <Typography variant="h6" style={{ color: '#ffffff' }}>MyTicket</Typography>
